module.exports = {
    ...
    execute(message, args, Discord) {
        const newEmbed = new Discord.MessageEmbed()
            ...
            .addFields({
                    name: 'Usage:',
                    value: "Use **!canuk** as a prefix. Use **[scores, scoreboard, or leaderboard]** for the HS and **[keywords]** for accepted keywords. Please remember to submit a picture of the battle summary screen for verification.\n \nTo submit an entry, use the format: \n`!canuk [dd, bb, cruiser, cv, universal] [damage, fires, torps, etc.] [value]` NOTE: Add the value W/O commas\n \n**EXAMPLE**: \n`!canuk dd fires 10` \n"
                }, {
                    name: '----- **Categories** -----',
