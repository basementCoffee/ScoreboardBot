...
bot.on("message", (message) => {
  ...
  if (
    message.author.bot ||
    (!message.content.startsWith(firstPrefix) &&
      !message.content.startsWith(secondPrefix))
  ) {
    return;
  }
  ...
  if (command === "bb" || command === "battleship") {
    ...
    let button = new disbut.MessageButton()
      .setStyle("url")
      .setURL(
        "https://docs.google.com/spreadsheets/d/1N_DoscLuWj2AZ90ZEDCQBH5FTFLaU-ZPriVi2ZKHkOo/edit?usp=sharing"
      )
      .setLabel("Holy Sheet");
    //.setDisabled();
